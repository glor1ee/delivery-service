    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('buyer', 'Покупатель'), ('courier', 'Курьер'), ('admin', 'Администратор')], default='buyer', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('market', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='delivery.market')),
            ],
        ),
        migrations.CreateModel(
            name='OrderItem',
